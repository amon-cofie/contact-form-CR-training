...
This project is a mock project built for trial review process of the code reviewer training exercise
...
You run this project in you browser with live server of open the index.html file in your web browser
